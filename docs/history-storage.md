...
Nimbus stores incidents, audit events, orders, and producer outbox state in the local PostgreSQL container. Telemetry samples, calculated service health, observed topology, and consumer receipts remain bounded in process memory and reset when their container restarts.
